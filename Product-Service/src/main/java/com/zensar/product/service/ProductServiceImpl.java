...
public class ProductServiceImpl implements ProductService {
	...
	public ProductDto insertProduct(ProductDto productDto) {
		...
		// CouponDto couponDto =
		// restTemplate.getForObject("http://localhost:4070/coupons/coupon/"+productDto.getCode(),CouponDto.class);

		// CouponDto couponDto =
		// restTemplate.getForObject("http://COUPONSERVICE/coupons/coupon/" +
		// productDto.getCode(),
		// CouponDto.class);

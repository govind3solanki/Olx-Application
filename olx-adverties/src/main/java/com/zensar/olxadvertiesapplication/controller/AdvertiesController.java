...
public class AdvertiesController {
	...
	public AdvertiseResponse addAdvertise(@RequestBody AdvertiseRequest advertise1, @RequestHeader("auth-token") String token) {
	...
	@GetMapping(value="/advertise/search/filtercriteria", produces = { MediaType.APPLICATION_XML_VALUE,
			MediaType.APPLICATION_JSON_VALUE })
	public List<AdvertiseResponse> getFilteredAdvertise(@RequestParam(value= "searchText",defaultValue = "OPEN", required = false) String searchText,@RequestParam(value= "category",defaultValue = "Computer Goods", required = false) String category) {
	...
	@GetMapping(value="/advertise/search", produces = { MediaType.APPLICATION_XML_VALUE,
			MediaType.APPLICATION_JSON_VALUE })
	public List<AdvertiseResponse> getAdvertiseByText(@RequestParam(value= "searchText", required = true) String searchText) {

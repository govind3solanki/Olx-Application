...
import com.zensar.couponservice.entity.Coupon;
import com.zensar.couponservice.entity.CouponDto;
import com.zensar.couponservice.repository.CouponRepository;
...
public class CouponServiceImpl implements CouponService{
	...
	public CouponDto findByCouponCode(String couponCode) {
		...
		return modelMapper.map(findByCouponCode,CouponDto.class);
	}
